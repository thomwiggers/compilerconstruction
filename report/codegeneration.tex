...
While translating the program into instructions that more closely resembled that of a processor did make it easy to generate assembly instructions, the loss of context aso\todo{aso?} made it much more difficult to retroactively debug what a (pseudo-)register represented.
