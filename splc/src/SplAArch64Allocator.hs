...
inputs (ORR _ a b)            = Set.fromList [a, b]
...
output (ORR o _ _)          = Set.singleton o
...
assignRegistersToInstruction (ORR rd ra rb) = ORR <$> outputRegister rd <*> inputRegister ra <*> inputRegister rb
